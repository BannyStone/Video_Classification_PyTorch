...
# data/kinetics400/kinetics_train_list.txt \
# data/kinetics400/kinetics_val_list.txt \
# --arch km_resnet50_3d_v2_0init_tem_reciprocal16_v3 \
# --dro 0.2 \
# --mode 3D \
# --t_length 16 \
# --t_stride 4 \
...
kinetics400 \
data/kinetics400/kinetics_val_list.txt \
output/kinetics400_km_resnet50_3d_v2_0init_tem_reciprocal16_v3_3D_length16_stride4_dropout0.2/model_best.pth \
--arch km_resnet50_3d_v2_0init_tem_reciprocal16_v3 \
--mode TSN+3D \
--batch_size 1 \
--num_segments 10 \
...
--workers 8 \
--image_tmpl image_{:06d}.jpg \
--save_scores output/kinetics400_km_resnet50_3d_v2_0init_tem_reciprocal16_v3_3D_length16_stride4_dropout0.2 \