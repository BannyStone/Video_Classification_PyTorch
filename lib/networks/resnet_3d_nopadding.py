...
class Bottleneck3D_100_nopad(nn.Module):
    expansion = 4

    def __init__(self, inplanes, planes, stride=1, t_stride=1, downsample=None):
        super(Bottleneck3D_100_nopad, self).__init__()
...
def resnet50_3d_nopad(pretrained=False, feat=False, **kwargs):
    """Constructs a ResNet-50 model.
    Args:
        pretrained (bool): If True, returns a model pre-trained on ImageNet
    """
    model = ResNet3D_nodown([Bottleneck3D_000, Bottleneck3D_000, Bottleneck3D_100_nopad, Bottleneck3D_100_nopad], 
